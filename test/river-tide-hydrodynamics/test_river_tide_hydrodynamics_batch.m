...
%
% TODO move first part of test-scripts to single file
% TODO test cases : store conditions in table-form and unify evaluation
% TODO test cases : automatically invert upstream and downstream bc
% TODO test case : cubic overtide
...
% TODO run river and no-river test cases for 2 and 3-tide
...
%		try
			...
			tab.RMSE_0{idx,1}   = sprintf('%0.4f',out(idx).rmse_d3d(1));
			tab.RMSE_1{idx,1}   = sprintf('%0.4f',out(idx).rmse_d3d(2));
			tab.RMSE_2{idx,1}   = sprintf('%0.4f',out(idx).rmse_d3d(3));
			tab.RMSE_3{idx,1}   = sprintf('%0.4f',out(idx).rmse_d3d(4));
